...
import static com.freedomotic.things.impl.EHWashingMachine.BEHAVIOR_WASHINGCYCLE;
...
public class EHHueLight
    ...
    protected final static String HUE_RED = "Red";
    protected final static String HUE_BLUE = "Blue";
    protected final static String HUE_GREEN = "Green";
    protected final static String HUE_YELLOW = "Yellow";
    protected final static String HUE_FUCSIA = "Fucsia";
    protected final static String HUE_WHITE = "White"; 
    ...
    protected final static String BEHAVIOR_COLORLIGHT = "colorlight";

    private ListBehaviorLogic colorLight;
    ...
    public void init() {
        ...
        colorLight = new ListBehaviorLogic((ListBehavior) getPojo().getBehavior(BEHAVIOR_COLORLIGHT));
        colorLight.addListener(new ListBehaviorLogic.Listener() {

            @Override
            public void selectedChanged(Config params, boolean fireCommand) {
                boolean executed = executeCommand("set color light", params);
                if (executed) {
                    setColorLight(params.getProperty("value"), params, fireCommand);
                }
            }
        });

        registerBehavior(colorLight);
        super.init();
    ...
    public void setColorLight(String selectedColor, Config params, boolean fireCommand) {
        if (!colorLight.equals(selectedColor)) {
            colorLight.setSelected(selectedColor);
            setChanged(true);
        }
    }
    ...
    protected void createCommands() {
        ...
        setHueBlue.setProperty("behavior", BEHAVIOR_COLORLIGHT);
        ...
        setHueRed.setProperty("behavior", BEHAVIOR_COLORLIGHT);
        ...
        setHueGreen.setProperty("behavior", BEHAVIOR_COLORLIGHT);
        ...
        setHueWhite.setProperty("behavior", BEHAVIOR_COLORLIGHT);
        ...
        setHueYellow.setProperty("behavior", BEHAVIOR_COLORLIGHT);
        ...
        setHueFucsia.setProperty("behavior", BEHAVIOR_COLORLIGHT);
